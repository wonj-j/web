      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">강남구, 논현로94길, 19</span>
          </div>
        </div>
          ...
          <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="index.html">서울</a>
              </li>
              <li class="breadcrumb-item">
                <a href="property-grid.html">강남역</a>
              </li>
              <li class="breadcrumb-item" aria-current="page">
      
                <a class="breadcrumb-item active" href="property-grid.html">양식</a>
              </li>
            </ol>
          </nav>
        </div>
          ...
          <ul class="nav nav-pills-a nav-pills mb-3 section-t3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="pills-video-tab" data-toggle="pill" href="#pills-video" role="tab"
                aria-controls="pills-video" aria-selected="true">메뉴판</a>
            </li>
            <li class="nav-item">
                  ...
                  <div id="carouselExampleControls" class="carousel slide" >
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/agent-1.jpg" alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/agent-2.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/agent-3.jpg" alt="Third slide">
                      </div>
                    </div>
            ...
            <div class="tab-pane fade show active" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
                ...
                <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
                  <div class="title-box-d">
                    ...
                    <input type="button" class="menu" value="메뉴판 사진 보기" id="btn5" data-toggle="modal" data-target="#dialog2">
                  </div>

                  <div class="property-description menu-list">
                    <img src="./img/post-1.jpg" class="menu-img">
                    <div class ="menu-item">김치 찌개 - <span class="menu-price">$15,000</span></div>
                    <div class="menu-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus perspiciatis repudiandae laboriosam explicabo recusandae ex error dignissimos earum. Et repudiandae quasi error nihil, qui aut id asperiores dolores repellendus quae!</div>
                    <div class="hit"></div>
                  ...
                  <div class="property-description menu-list">
                    <img src="./img/post-1.jpg" class="menu-img">
                    <div class ="menu-item">이탈리안 피자 - <span class="menu-price">$15,000</span></div>
                    <div class="menu-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus perspiciatis repudiandae laboriosam explicabo recusandae ex error dignissimos earum. Et repudiandae quasi error nihil, qui aut id asperiores dolores repellendus quae!</div>
                    <div class="hit"></div>
                  ...
                  <ul class="list-comments">
                    <li>
                      ...
                      <div class="comment-details">
                        <h4 class="comment-author">aaa</h4>
...
<!--                         <form method="POST" action="/bnb/tour/tourcomment.do"> -->
                        <input type="button" value="reply" id="reply" />
                        <input type="text" id="reply-text" style="display: none;"/>
<!--                         </form> -->
                      </div>
                    </li> 
                ...
                <div class="form-comments">
                  ...
                  <form id="form1">
	                  <div id="reviewstar">
	                    <div id="review-info">
	                      <img src="img/man_04.png" alt="" id="myimg" name="myimg">
	                      ...
	                      <div class="starRev">
	                        ...
	                        <span class="point" id="point">0.0</span><span class="man">/5.0</span>
	                    ...
	                    <div id="myreview">
	                      <textarea name="" id="comment" name="comment" cols="84" rows="6" placeholder="리뷰를 남겨주세요
	                                      ." required></textarea>
	                      <input type="submit" id="leave-review" value="리뷰작성하기" class="btn btn-default">
	                    </div> <!-- myreview -->
            ...
            <div class="tab-pane fade" id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab">
                <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
                    ...
                    <div class="amenities-list color-text-a">
                        <ul class="no-margin">
                            <li style="list-style-type: none;"><i class="fa fa-clock-o" aria-hidden="true"></i> 평일 16:00 - 24:00</li>
                            <li style="list-style-type: none;"><i class="fa fa-clock-o" aria-hidden="true"></i> 토요일 16:00 - 23:30</li>
                            <li style="list-style-type: none;"><i class="fa fa-clock-o" aria-hidden="true"></i> 일요일 16:00 - 23:30</li>
                            <li style="list-style-type: none;"><i class="fa fa-map-marker" aria-hidden="true"></i> 서울 강남구 강남대로 110길 14</li>
                            <li style="list-style-type: none;"><i class="fa fa-home" aria-hidden="true"></i> 단체석, 주차, 예약, 무선 인터넷, 남/녀 화장실 구분</li>
